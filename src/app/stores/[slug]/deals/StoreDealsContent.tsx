...
export default function StoreDealsContent({ store }: { store: Store }) {
  ...
  // Filter to deals only (no promo code)
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 10, padding: "28px 24px 24px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "4px" }}>
              <span className="material-symbols-outlined" style={{ fontSize: "20px", color: brandTheme.textColor }}>local_offer</span>
              <h1 style={{
            ...
            <p style={{
              ...
              {dealsOnly.length} active deals and discounts for {monthYear}
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 pb-12">
        <div style={{
          ...
          <h3 style={{ fontSize: "16px", fontWeight: 900, color: "#1A1A1A", marginBottom: "12px" }}>
            {store.name} Deals & Discounts for {monthYear}
          </h3>
          <p style={{ fontSize: "13px", color: "#666", lineHeight: 1.7 }}>
            Browse the latest {store.name} deals, sales, and discounts — no coupon code needed.
            Just click through to activate your savings. Our community votes on every deal
            to help you find the best {store.name} offers available right now.
          </p>
        </div>
      </section>
    </>
